        ...
        function getCookie(name)
{
	...
	$(".confirm_step-two_submit a").click(function(){
...
<body id="confirm_step_one_body"> 
  ...
  <!-- order_list -->
    ...
    <div class="shipping_config order_configs">
       <span class="confirm_step_two_title"><span class="confirm_step_two_title_1"></span>餐品清单</span>
        <div style="float:right;margin-top:-41px;font-size:12px;"><span>配送时间:11:00AM-12:00AM<span></div>
...
?>
   ...
   <div class="confirm_step_three_amount float_left">
         ...
         共&nbsp;&nbsp;<span class="views_cart_number"></span>&nbsp;&nbsp;份&nbsp;&nbsp;
...
<div id="config_info" class="order_configs">
        <div class="confirm_step_two_title"><span class="confirm_step_two_title_2"></span>配送信息<button class="new_address_confirm">+ 新增</button></div>
     </div>
         ...
         <li id="three_last_li2" >
           ...
           <div class="three_input_div float_left address_detail">
             <!-- <input type="hidden" name="extra_building_name" id="extra_building_name"  placeholder="请输入写字楼名称" value="" /><span class="error_note"></span>
              <br/>-->
              <input type="text" name="extra_building_address" id="extra_building_address"  value="" /><span class="error_note"></span>
              </div>  
         </li>
...
<div id="config_pay" class="order_configs">
        <div class="confirm_step_two_title"><span class="confirm_step_two_title_3"></span>支付方式<i class="config_title_ii"></i></div>
     </div>
