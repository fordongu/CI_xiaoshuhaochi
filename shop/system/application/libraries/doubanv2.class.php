...
class Douban_Tclientv2{
	...
	*/
     ...
     */
      ...
      * @param int $count
      */
     function drama_comments($id,$start=0,$count=20){
     
     	$request_url = "https://api.douban.com/v2/drama/".$id."/comments";
     	$params['start'] = $start;
     	$params['count'] = $count;
     	return $this->oauth->get($request_url,$params);
     }
     ...
     function drama_reviews($id,$start=0,$count=10){
     	 
     	$request_url = "https://api.douban.com/v2/drama/".$id."/reviews";
     	$params['start'] = $start;
     	$params['count'] = $count;
     	return $this->oauth->get($request_url,$params);
     }
     ...
     */
     ...
     function drama_getbyid($id)
     {
     	$request_url = "http://api.douban.com/v2/drama/".$id;
     	return $this->oauth->get($request_url);
     }
