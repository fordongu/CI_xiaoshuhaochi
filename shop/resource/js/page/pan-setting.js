$(function(){
	 var validator = $("#panform").validate({
			...
			rules: {
				...
				prize1: {required: true,maxlength: 50},prize2: {required: true,maxlength: 50},prize3: {required: true,maxlength: 50},prize4: {required: true,maxlength: 50},prize5: {required: true,maxlength: 50},
				amount1:{required: true,number:true,range:[1,500]},amount2:{required: true,number:true,range:[1,500]},amount3:{required: true,number:true,range:[1,500]},amount4:{required: true,number:true,range:[1,500]},amount5:{required: true,number:true,range:[1,500]},
			...
			messages: {
				...
				prize1: {required: "不能为空",maxlength: "不能超过50个字"},prize2: {required: "不能为空",maxlength: "不能超过50个字"},prize3: {required: "不能为空",maxlength: "不能超过50个字"},prize4: {required: "不能为空",maxlength: "不能超过50个字"},prize5: {required: "不能为空",maxlength: "不能超过50个字"},
				...
				amount4:{required: "不能为空",number:"必须是数字",range:$.validator.format("数量必须是大于{0}且小于 {1}.")},
				amount5:{required: "不能为空",number:"必须是数字",range:$.validator.format("数量必须是大于{0}且小于 {1}.")},
			...
			submitHandler: function() {
				...
				var submitData = {
						...
						amount4: $("input[name='amount4']", $form).val(),
						amount5: $("input[name='amount5']", $form).val(),
						...
						prize4: $("input[name='prize4']", $form).val(),
						prize5: $("input[name='prize5']", $form).val(),						
				...
				$.post('/main/pan_setting', submitData,function(data) {
