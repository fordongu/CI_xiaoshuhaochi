 $(document).ready(function(){ 
    ...
    $('#save_address').click(function(){
                    	 ...
                    	 if(company == 0){
                    		 $('#company').next('span').html('公司不能空');
  							return false;
                    	 }else{
                   	    	$('#company').next('span').html('');
                   	      }
                    	  ...
                    	  if((company==-1)&&(!extra_address)){ 
   						    $('#extra_address').next('span').html('请填写公司地址');
   							return false;
                  	      }else{
                    	    	$('#extra_address').next('span').html('');
                      	  }
