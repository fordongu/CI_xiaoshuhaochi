...
<?php $user_cookie=$_COOKIE["user_cookie"]?unserialize($_COOKIE["user_cookie"]):"";
?>
     ...
     <ul>
      ...
      <li>
        <ol>
          ...
          <li class="person_name"><span><?php if($user_cookie->tu_mobile){echo $user_cookie->tu_mobile;}?></span></li>
        </ol>
      </li>
      <li>
        <ol>
   ...
   <div class="views_main_login">
    ...
    <!--<form method="post" enctype="multipart/form-data" action=http://dev.xiaoshuhaochi.com/main/user_login>-->
     <ul>
       ...
       <li>
         <label>
           <input id="remember_password" type="checkbox" checked /> 记住密码
         </label>
         <a href="javascript:;" id="fogot_password">忘记密码 ？</a>
       </li>
