...
function GetRTime() {
  ...
  //ordering_notice
  $('.ordering_notice').css('height',document.documentElement.clientHeight+'px');
 $('.ordering_notice_header ul > li:nth-child(2)').click(function(){
    $('.ordering_notice').animate({scrollTop:440});
    $('.ordering_notice_up').fadeIn();
 });
 $('.ordering_notice_header ul > li:nth-child(3)').click(function(){
    $('.ordering_notice').animate({scrollTop:750});
    $('.ordering_notice_up').fadeIn();
 });
 $('.ordering_notice_header ul > li:nth-child(4)').click(function(){
    $('.ordering_notice').animate({scrollTop:970});
    $('.ordering_notice_up').fadeIn();
 });
 $('.ordering_notice_header ul > li:nth-child(5)').click(function(){
    $('.ordering_notice').animate({scrollTop:1200});
    $('.ordering_notice_up').fadeIn();
 });
 $('.ordering_notice_up').click(function(){
    $('.ordering_notice').animate({scrollTop:0});
 });
	//main => new-header.php  End
